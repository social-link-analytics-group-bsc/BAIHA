...
DEFAULT_bench_event_id = "OEBE0130000000"
EVENT = "BAIHA-sex-bias-training-datasets"
    ...
    for item in template:
        ...
        if viz["type"] == Visualisations.TWODPLOT.value:
            ...
            for x_win in [m for m in metrics_ids if x in m]:
                ...
                # but in this case, it is just comparing two metrics from one challenge
                # Or maybe the issue isn't with this but with way keys are in the 'challenge' dictionary
